...
class ClassificationDataset:
    ...
    def __init__(self, root, args, augment=False, prefix=""):
        ...
        self.pairs_rgb_depth=getattr(args, 'pairs_rgb_depth', ['visible', 'depth'])
    ...
    def __getitem__(self, i):
        ...
        if self.cache_ram:
            if im is None:  # Warning: two separate if statements required here, do not combine this with previous line
                im = self.samples[i][3] = self.load_and_preprocess_image(f, use_simotm=self.use_simotm, pairs_rgb=pairs_rgb, pairs_ir=pairs_ir, pairs_depth=pairs_d)
